...
$media = blogtwist_video_attachment(); ?>
<article id="single-post-<?php the_ID(); ?>" <?php post_class('wpmotif-post wpmotif-post-single'); ?>>
    <header class="entry-header">
        ...
        <span class="entry-meta entry-format">
            <a href="<?php echo esc_url(get_post_format_link('video')); ?>"
               title="<?php echo sprintf(esc_attr__('All %s posts', 'blogtwist'), get_post_format_string('video')); ?>">
